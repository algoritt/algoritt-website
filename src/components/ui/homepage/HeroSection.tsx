...
const HeroSection: React.FC = () => {
    return (
        <section className="relative w-full min-h-screen pb-24 overflow-hidden flex items-center">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex items-center">
                <div className="max-w-3xl mx-auto text-center text-white">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-8">
