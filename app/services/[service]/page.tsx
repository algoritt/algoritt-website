              ...
              {serviceData.process?.map((step, index) => (
                ...
                >
                  <div className="flex-none">
                    <div className="w-12 h-12 rounded-full bg-purple-500/20 border border-purple-500/50 flex items-center justify-center text-xl font-bold text-purple-400">
                      {index + 1}
                    </div>
                  </div>
                  <div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                Why choose our {serviceData.title.toLowerCase()} service
              </p>
            </div>
